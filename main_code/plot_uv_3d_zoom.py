...
colormap    = "viridis"
colornum    = 4
fig_name    = "uv3d_83pi_zoom_figviridis"
dpi         = 200
padtext_x   = 50
padtext_y   = 10
padtext_z   = 7
...
plotstruc3d_separe_trim(data_in={"struc":uv_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
                                 "zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,"figsize_y":figsize_y,
                                 "colormap":colormap1,"colornum":colornum,"fig_name":fig_name,"dpi":dpi,"dy":dy,
                                 "dx":dx,"dz":dz,"uvw_folder":uvw_folder,"uvw_file":uvw_file,"L_x":L_x,"L_y":L_y,
                                 "L_z":L_z,"rey":rey,"utau":utau,"cmap_flag":False,
                                 "padtext":[padtext_x,padtext_y,padtext_z],"xtrim":[0,70],
                                 "ztrim":[120,180],"alpha":0.5})


plotstruc3d_separe_coin_trim(data_in={"struc":uv_struc,"struc2":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,
                                      "ylabel":ylabel,"zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,
                                      "figsize_y":figsize_y,"colormap":colormap1,"colormap2":colormap2,
                                      ...
                                      "rey":rey,"utau":utau,"cmap_flag":False,"cmap_flag2":False,
                                      "padtext":[padtext_x,padtext_y,padtext_z],"xtrim":[0,70],
                                      "ztrim":[120,180],"alpha":0.5})