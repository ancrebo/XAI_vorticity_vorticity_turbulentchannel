...
import os
from py_bin.py_functions.normalization_vor import calc_norm as calc_norm_vor
from py_bin.py_functions.vormean import calc_vormean
...
folder_vor   = folders.vor_folder
file_vor     = folders.vor_file
...
# Calculate the mean values of the velocity
# -----------------------------------------------------------------------------------------------------------------------
Data_vormean={"field_ini":field_ini,"field_fin":field_fin,"folder":folder_vor,"file":file_vor,"save_file":save_file,
            "vormean_file":vormean_file,"data_folder":data_folder,"shpx":flow.shpx,"shpy":flow.shpy,"shpz":flow.shpz}
calc_vormean(data_in=Data_vormean)
# -----------------------------------------------------------------------------------------------------------------------
# Calculate the normalization values for the dataset
# -----------------------------------------------------------------------------------------------------------------------
data_norm={"field_ini":field_ini,"field_fin":field_fin,"data_folder":data_folder,
            "dx":dx,"dy":dy,"dz":dz,"folder":folder_vor,"file":file_vor,"shpx":flow.shpx,"shpy":flow.shpy,"shpz":flow.shpz,
            "save_file":save_file,"vornorm_file":vornorm_file,"vormean_file":vormean_file}
calc_norm_vor(data_in=data_norm)