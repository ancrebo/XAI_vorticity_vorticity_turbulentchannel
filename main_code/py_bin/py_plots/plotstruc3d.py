...
def plotstruc3d_separe_trim(data_in={"struc":[],"plot_folder":"plots","xlabel":"$x^+$","ylabel":"$y^+$","zlabel":"z^+",
    ...
    data_in : dict, optional
        ...
        The default is {"struc":[],"plot_folder":"plots","xlabel":"$x^+$","ylabel":"$y^+$","zlabel":"z^+",
                        ...
                        "fig_name":"struc3d","dpi":60,"dy":1,"dx":1,"dz":1,"uvw_folder":"../../P125_21pi_vu/",
                        "uvw_file":"P125_21pi_vu.$INDEX$.h5.uvw","L_x":2*np.pi,"L_y":1,"L_z":np.pi,
                        "rey":125,"utau":0.060523258443963,"cmap_flag":False,"padtext":[0,0,0],"alpha":1}.
        Data:
            - struc       : data of the structures
            - plot_folder : folder to store the figures
            - xlabel      : label of the x axis
    ...
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,"data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_low,
                  "color":colormap,"cmap_flag":cmapflag,"vmax":None,"vmin":None,"alpha":alpha}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
...
def plotstruc3d_separe_coin_trim(data_in={"struc":[],"struc2":[],"plot_folder":"plots","xlabel":"$x^+$",
                                          "ylabel":"$y^+$","zlabel":"z^+",
                                          "fontsize":18,"figsize_x":10,"figsize_y":8,"colormap":"viridis",
                                          "colormap2":"viridis","colornum":2,
                                          "fig_name":"struc3d","dpi":60,"dy":1,"dx":1,"dz":1,
                                          "uvw_folder":"../../P125_21pi_vu/",
                                          "uvw_file":"P125_21pi_vu.$INDEX$.h5.uvw","L_x":2*np.pi,"L_y":1,"L_z":np.pi,
                                          "rey":125,"utau":0.060523258443963,"cmap_flag":False,"cmap_flag2":False,
                                          "padtext":[0,0,0],"xtrim":[50,100],"ztrim":[50,100],"alpha":1}):
    """
    .....................................................................................................................
    # plotstruc3d_separe: Function to generate the plot of the 3d structures separated in 2 semichannels
    .....................................................................................................................
    ...
    data_in : dict, optional
        Data required for generating the plot. 
        The default is {"struc":[],"plot_folder":"plots","xlabel":"$x^+$","ylabel":"$y^+$","zlabel":"z^+",
                        "fontsize":18,"figsize_x":10,"figsize_y":8,"colormap":"viridis","colormap2":"viridis","colornum":2,
                        "fig_name":"struc3d","dpi":60,"dy":1,"dx":1,"dz":1,"uvw_folder":"../../P125_21pi_vu/",
                        "uvw_file":"P125_21pi_vu.$INDEX$.h5.uvw","L_x":2*np.pi,"L_y":1,"L_z":np.pi,
                        "rey":125,"utau":0.060523258443963,"cmap_flag":False,"cmap_flag2":False,"padtext":[0,0,0],"alpha":1}.
        Data:
            - struc       : data of the structures
            - plot_folder : folder to store the figures
            - xlabel      : label of the x axis
            ...
            - utau        : friction velocity
            - cmap_flag   : flag to use a color map (True) or solid color (False)
            - cmap_flag2  : flag to use a color map (True) or solid color (False)
            - padtext     : padding used for the labels text
            - alpha       : alpha channel value
    ...
    utau        = float(data_in["utau"])
    cmapflag    = bool(data_in["cmap_flag"])
    cmapflag2   = bool(data_in["cmap_flag2"])
    padtext     = np.array(data_in["padtext"],dtype="int")
    padtext_x   = padtext[0]
    padtext_y   = padtext[1]
    padtext_z   = padtext[2]
    ...
    plot_train = plot_format(data_in=data_plot)
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,
                  "data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_low_di,
                  "color":colormap,"cmap_flag":cmapflag,"vmax":None,"vmin":None,"alpha":alpha}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_info2 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,
                  "data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_low_un,
                  "color":colormap2,"cmap_flag":cmapflag2,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info2)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
                                       "zticks":[0,L_y*rey],
    ...
    plot_train.create_figure3d()
    plot_info1 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,
                  "data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_upp_di,
                  "color":colormap,"cmap_flag":cmapflag,"vmax":None,"vmin":None,"alpha":alpha}
    plot_train.add_plot_3d_structure(data_in=plot_info1)
    plot_info2 = {"data_x":flow_data.xplus[xtrim[0]:xtrim[1]],"data_y":flow_data.yplus,
                  "data_z":flow_data.zplus[ztrim[0]:ztrim[1]],"struc":mat_segment_upp_un,
                  "color":colormap2,"cmap_flag":cmapflag2,"vmax":None,"vmin":None}
    plot_train.add_plot_3d_structure(data_in=plot_info2)
    plot_train.plot_layout_3d(data_in={"xticks":[flow_data.xplus[xtrim[0]],flow_data.xplus[xtrim[1]]],
                                       "yticks":[flow_data.zplus[ztrim[0]],flow_data.zplus[ztrim[1]]],
