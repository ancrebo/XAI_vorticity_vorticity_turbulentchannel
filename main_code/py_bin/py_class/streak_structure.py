...
class streak_structure():
    ...
    def divide_high_low(self):
        ...
        u_vol_sign                                   = np.multiply(np.sign(self.field_u),self.mesh_vol).reshape(-1)
        ...
        self.type  = np.zeros((int(max_struc),))
        for index_struc in ind_vol:
            grid_struc  = np.nonzero(mat==index_struc+1)
            struc_signu = np.sum(u_vol_sign[grid_struc])
            type_struc  = np.sign(struc_signu)
    ...
    def calc_enstrophy(self,data_in={"ens_folder":"-","ens_file":"-"}):
        ...
        # calc_enstrophy
        .................................................................................................................
        Function for calculating the enstrophy of the streaks
