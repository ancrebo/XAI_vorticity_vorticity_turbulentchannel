...
class shap_structure():
    ...
    def __init__(self,data_in={"uvw_folder":"../../P125_21pi_vu/","uvw_file":"P125_21pi_vu.$INDEX$.h5.uvw","Hperc":1.75,
                               ...
                               "urms_file":"SHAPrms.txt","vormean_file":"vormean.txt",
                               "sym_quad":True,"filvol":2.7e4,
        ...
        self.vor_file     = str(data_in["vor_file"])
        self.vor_folder   = str(data_in["vor_folder"])
        ...
        data_shap   = {"shap_folder":self.shap_folder,"shap_file":self.shap_file,"uvw_folder":self.uvw_folder,
                       "uvw_file":self.uvw_file,"vor_folder":self.vor_folder,"vor_file":self.vor_file,
                       "padding":self.padding,"dx":self.down_x,"dy":self.down_y,
                       "dz":self.down_z,"data_folder":self.data_folder,"umean_file":self.umean_file,
                       "unorm_file":"-","vormean_file":self.vormean_file,"vornorm_file":"-",
                       "L_x":self.L_x,"L_z":self.L_z,"L_y":self.L_y,"rey":self.rey,
