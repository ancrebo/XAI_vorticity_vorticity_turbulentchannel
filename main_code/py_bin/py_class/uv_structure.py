...
class uv_structure():
    ...
    def detect_quadrant(self):
        """
        .................................................................................................................
        # Detect the quadrant of the Qs
        .................................................................................................................
        Function for detecting the quadrant of the Qs
        ...
        u_dot_vol  = np.multiply(np.sign(self.field_u),self.mesh_vol).reshape(-1)
        v_dot_vol  = np.multiply(np.sign(self.field_v),self.mesh_vol).reshape(-1)
        y_dot_vol  = np.multiply(y_h,self.mesh_vol).reshape(-1)
        mat        = self.structures.mat_segment.reshape(-1)
        ind_vol    = np.nonzero(self.structures.vol>self.filvol)[0]
        for index_struc in ind_vol:
                grid_struc  = np.nonzero(mat==index_struc+1)
                cdgy_struc  = np.sum(y_dot_vol[grid_struc])
                struc_signu = np.sum(u_dot_vol[grid_struc])
                struc_signv = -np.sign(cdgy_struc)*np.sum(v_dot_vol[grid_struc])
                type_struc  = 1+(struc_signu/struc_signv<=0)+2*(struc_signv<=0)
                self.event[index_struc] = type_struc
                
                
    def create_mat_event(self):
        """
        .................................................................................................................
        # Creates a matrix identifying each structure with a different event
        .................................................................................................................
        Function for creating the matrix field with the different events
        ...
        """
        self.mat_event = np.zeros_like(self.structures.mat_segment)
        mat            = self.structures.mat_segment.reshape(-1)
        event          = np.zeros_like(mat)
        ind_vol        = np.nonzero(self.structures.vol>self.filvol)[0]
        for index_struc in ind_vol:
            event[mat==index_struc+1] = self.event[index_struc]
        self.mat_event = event.reshape(self.shpy,self.shpz,self.shpx)
        
         
    def calc_enstrophy(self,data_in={"ens_folder":"-","ens_file":"-"}):
        """
        .................................................................................................................
        # calc_enstrophy
        .................................................................................................................
        Function for calculating the enstrophy of the uv structure
        
        Parameters
        ----------
        data_in : dict, optional
            Name of the folder and file of the file of the enstrophy data.
            The default is {"ens_folder":"-","ens_file":"-"}.
            Data:
                - ens_folder : folder of the enstrophy
                - ens_file   : file of the enstrophy
        ...
        # Import packages
        # ---------------------------------------------------------------------------------------------------------------
        from py_bin.py_functions.read_enstrophy import read_enstrophy
        
        # ---------------------------------------------------------------------------------------------------------------
        # Read the data
        # ---------------------------------------------------------------------------------------------------------------
        ens_folder = str(data_in["ens_folder"])
        ens_file   = str(data_in["ens_file"])
        
        # ---------------------------------------------------------------------------------------------------------------
        # Read the enstropy file
        # ---------------------------------------------------------------------------------------------------------------
        ens = read_enstrophy(data_in={"folder":ens_folder,"file":ens_file,"index":self.index,
                                      "dx":self.down_x,"dy":self.down_y,"dz":self.down_z,"shpx":self.shpx,
                                      "shpy":self.shpy,"shpz":self.shpz,"padding":0})["ens"]
        
        # ---------------------------------------------------------------------------------------------------------------
        # Calculate the enstropy of the structure
        # ---------------------------------------------------------------------------------------------------------------
        max_struc      = np.max(self.structures.mat_segment)
        mat            = self.structures.mat_segment.reshape(-1)
        ens_vec        = ens.reshape(-1)
        ind_vol        = np.nonzero(self.structures.vol>self.filvol)[0]
        ens_tot        = np.sum(ens)
        self.ens_struc = np.zeros((max_struc,))
        for index_struc in ind_vol:
            self.ens_struc[index_struc] = np.sum(ens_vec[mat==index_struc+1])/ens_tot