...
class plot_format():
    ...
    def add_hist2d_y_cont(self,data_in={"xx":[],"yy":[],"xxyy":[],"levels":[1,2,3,4],"colormap":"viridis",
                                        "locator":[],"alp":1,"linewidth":2,"cmapflag":True,"linestyle":"-"}):
        """
        .................................................................................................................
        # add_hist2d_y_cont
        .................................................................................................................
        ...
        data_in : dict, optional
            ...
            Data:
                ...
                - alp       : alpha channel of the plot
                - linewidth : linewidth of the contour
                - cmapflag  : flag for choosing if the map has to be used
        ...
        if color_read is None:
            ...
            if isinstance(color_read, np.ndarray):
                color  = np.array(color_read)
            else:
                color  = str(color_read)
        if cmapflag:
            colormap = matplotlib.cm.get_cmap(color,nlev)
        if "linestyle" in data_in:
            linestyle = str(data_in["linestyle"])
        else:
            linestyle = "-"
        ...
        self.figure
        if cmapflag:
            im1 = ax.contour(xx,yy,xxyy,levels=levels,cmap=colormap,
                             vmin=lev_min,vmax=levels[-1],locator=locator,linewidths=linewidth,linestyles=linestyle)
        else:
            im1 = ax.contour(xx,yy,xxyy,levels=levels,colors=color,
                             vmin=lev_min,vmax=levels[-1],locator=locator,linewidths=linewidth,linestyles=linestyle)
        self.plot.append(im1)
