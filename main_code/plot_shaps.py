...
# -----------------------------------------------------------------------------------------------------------------------
folder_def  = "test_deltat10" #"test_deltat20" #"test_deltat10" #"P125_83pi_240603_v0_definitions" #  "test_deltat20" #  "P125_83pi_240603_v0_definitions" # "P550_21pi_250225_v2_definitions"
...
colormap    = "viridis"
colornum    = 3
fig_name    = "shapfield_dt10" #"shapfield_dt20" # "shapfield_dt5" #"shapfield_550" #"shapfield_dt5" # "shapfield_noise_11fields"
dpi         = 200
index_ii    = 20000
index_y     = 5
ymin        = 0
...
if setnorm:
    ...
    if index_y == 20:
        normdata["max_u"] = 2e-5
        normdata["max_v"] = 0.75e-5
        normdata["max_w"] = 1.5e-5
        normdata["vmax_vel_u"] = 0.5
        normdata["vmin_vel_u"] = -0.5
        normdata["vmax_vel_v"] = 0.2
        normdata["vmin_vel_v"] = -0.2
        normdata["vmax_vel_w"] = 0.3
        normdata["vmin_vel_w"] = -0.3
        normdata["vmax_vel_m"] = 0.5
        normdata["vmin_vel_m"] = 0
    elif index_y == 5:
        normdata["max_u"] = 0.4e-5
        normdata["max_v"] = 0.02e-5
        normdata["max_w"] = 0.3e-5
        normdata["vmax_vel_u"] = 0.3
        normdata["vmin_vel_u"] = -0.3
        normdata["vmax_vel_v"] = 0.02
        normdata["vmin_vel_v"] = -0.02
        normdata["vmax_vel_w"] = 0.2
        normdata["vmin_vel_w"] = -0.2
        normdata["vmax_vel_m"] = 0.3
        normdata["vmin_vel_m"] = 0
    elif index_y == 10:
        normdata["max_u"] = 1.2e-5
        normdata["max_v"] = 0.1e-5
        normdata["max_w"] = 0.8e-5
        normdata["vmax_vel_u"] = 0.5
        normdata["vmin_vel_u"] = -0.5
        normdata["vmax_vel_v"] = 0.08
        normdata["vmin_vel_v"] = -0.08
        normdata["vmax_vel_w"] = 0.3
        normdata["vmin_vel_w"] = -0.3
        normdata["vmax_vel_m"] = 0.6
        normdata["vmin_vel_m"] = 0
    elif index_y == 40:
        normdata["max_u"] = 1.6e-5
        normdata["max_v"] = 0.5e-5
        normdata["max_w"] = 1e-5
        normdata["vmax_vel_u"] = 0.4
        normdata["vmin_vel_u"] = -0.4
        normdata["vmax_vel_v"] = 0.2
        normdata["vmin_vel_v"] = -0.2
        normdata["vmax_vel_w"] = 0.3
        normdata["vmin_vel_w"] = -0.3
...
data_plot={"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,"fontsize":fontsize,"figsize_x":figsize_x,
           ...
           "keepnorm":keepnorm,"normdata":normdata}
