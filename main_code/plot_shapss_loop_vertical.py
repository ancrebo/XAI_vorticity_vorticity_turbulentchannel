...
from py_bin.py_plots.plotshap import plotshap_vertical_struc
...
colormap    = "viridis"
colornum    = 3
fig_name    = "shapstrucfield_evolvevertical_"
dpi         = 200
index_ii    = 20001
index_z     = 50
ymin        = 0
...
for index_ii in range(20000,20010):
    ...
    data_plot={"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,"fontsize":fontsize,"figsize_x":figsize_x,
               ...
               "index_ii":index_ii,"shap_data":shap_struc,"flowfield":flowfield,"index_z":index_z,
    ...
    plotshap_vertical_struc(data_in=data_plot)