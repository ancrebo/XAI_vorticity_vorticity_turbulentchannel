...
vor_folder = '/poiseuille/P125_83/vor/'
...
tfrecord_folder   = '//lustre/scratch/serhocal@upvnet.upv.es/P125/tf/tfrecord_vor/'
...
#     - perc_SHAP_file      : File of the percolation of the shap structures
# ----------------------------------------------------------------------------------------------------------------------
data_folder         = "/poiseuille/P125_83/sta_vor"
...
# ----------------------------------------------------------------------------------------------------------------------
model_folder = "/poiseuille/P125_83/models_vor/"
...
# ----------------------------------------------------------------------------------------------------------------------
plot_folder = "/poiseuille/P125_83/plots_vor/"
...
SHAPq_folder     = "/poiseuille/P125_83/SHAPq_vor/"
SHAPq_file       = "P125_83pi_nsample$NSAMPLES$.$INDEX$.shap"
SHAPq_uvw_folder = "/data1/P125/structures/SHAPuvw_vor/"
...
# ----------------------------------------------------------------------------------------------------------------------
shap_folder           = "/poiseuille/P125_83/SHAP_d20250507_vor"
shap_file             = "P125_83pi_nsample$NSAMPLES$.$INDEX$.h5.shap"
shapseg_uv_folder     = "/poiseuille/P125_83/SHAPsegment_uv_d20250507_vor"
shapseg_uv_file       = "P125_83pi_segment_uv.$INDEX$.h5.shap"
shapseg_chong_folder  = "/poiseuille/P125_83/SHAPsegment_chong_d20250507_vor"
shapseg_chong_file    = "P125_83pi_segment_chong.$INDEX$.h5.shap"
shapseg_streak_folder = "/poiseuille/P125_83/SHAPsegment_streak_d20250507_vor"
