...
folders_str = "folders"#"_local_tbdb4"
...
# ----------------------------------------------------------------------------------------------------------------------
DL_data  = {"uvw_folder":uvw_folder,"uvw_file":uvw_file,"vor_folder":vor_folder,"vor_file":vor_file,"padding":padding,
            "dx":dx,"dy":dy,"dz":dz,"data_folder":data_folder,"umean_file":umean_file,"vormean_file":vormean_file,
            "unorm_file":unorm_file,"vornorm_file":vornorm_file,"L_x":L_x,"L_z":L_z,"L_y":L_y,"uvw_folder_tf":uvw_folder_tf,
